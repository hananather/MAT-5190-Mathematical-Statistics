...
\subsection{Basics Concepts of Probability Theory}
...
Given a probability space $(S, \SF, \PP)$, the main objective of probability theory is that of calculating probabilities of events which may be of importance to us. The sample space $S$ may be quite an abstract set, thus we can faciliate our calculations by a transformation of the sample space $S$, into a subset of the real line $\RR$. This is achieved by a \vocab{random variable}
\footnote{A random variable is a real-valued function with a domain $\Omega$ which as an extra property called \vocab{measurability}.}
